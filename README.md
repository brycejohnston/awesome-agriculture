...
- [FAOSTAT](https://www.fao.org/faostat/en/) - UN FAO database of food and agriculture statistics covering production, trade, land use, and emissions for 245+ countries. Provides free API access and bulk download.
- [Growstuff](https://www.growstuff.org/crops) - Record keeping & crop database, nice API
- [Our World in Data — Environmental Impacts of Food](https://ourworldindata.org/environmental-impacts-of-food) - Dataset and charts covering greenhouse gas emissions, land use, and water use per food product, compiled from peer-reviewed sources.
